...
class PageIndicatorActions {
  ...
  static PageIndicatorActions appsAction = PageIndicatorActions._(
    ...
    key: ValueKey('dashboard_page_indicator_apps_action_button_key'),
    isEnabled: (viewModel) => viewModel.shouldShowMarketPlaceInDashboard,
  );
  ...
  static PageIndicatorActions homeAction = PageIndicatorActions._(
    ...
    key: ValueKey('dashboard_page_indicator_home_action_button_key'),
  );
  ...
  static PageIndicatorActions historyAction = PageIndicatorActions._(
    ...
    key: ValueKey('dashboard_page_indicator_history_action_button_key'),
  );
}
