import 'package:hash_wallet/src/screens/yat/widgets/first_introduction.dart';
import 'package:hash_wallet/src/screens/yat/widgets/second_introduction.dart';
import 'package:hash_wallet/src/screens/yat/widgets/third_introduction.dart';
...
class YatPopup extends StatelessWidget {
  YatPopup({required this.dashboardViewModel, required this.onClose})
      : baseUrl = YatLink.isDevMode ? YatLink.baseDevUrl : YatLink.baseReleaseUrl;
                    ...
                    children: [
                      Column(children: [
                        Row(
                            ...
                            children: [YatCloseButton(onClose: onClose)]),
                        Row(
                            mainAxisSize: MainAxisSize.max,
                      ...
                      Container(
                          ...
                          child: Column(children: [
                            Text(S.of(context).yat_popup_title,
                            ...
                            Padding(
                                ...
                                child: Text(S.of(context).yat_popup_content,
                                    textAlign: TextAlign.center,
                      ...
                      PrimaryButton(
                          ...
                          onPressed: () => dashboardViewModel.isShowFirstYatIntroduction = true)
                    ],
                  ))),
        ),
        Observer(
            builder: (_) => dashboardViewModel.isShowFirstYatIntroduction
                ? SlideInRight(
                    from: screenWidth,
                    duration: Duration(milliseconds: durationInMilliseconds),
                    child: FirstIntroduction(
                        onClose: onClose,
                        onNext: () => dashboardViewModel.isShowSecondYatIntroduction = true))
                : Container()),
        Observer(
            builder: (_) => dashboardViewModel.isShowSecondYatIntroduction
                ? SlideInRight(
                    from: screenWidth,
                    duration: Duration(milliseconds: durationInMilliseconds),
                    child: SecondIntroduction(
                        onClose: onClose,
                        onNext: () => dashboardViewModel.isShowThirdYatIntroduction = true))
                : Container()),
        Observer(
            builder: (_) => dashboardViewModel.isShowThirdYatIntroduction
                ? SlideInRight(
                    from: screenWidth,
                    duration: Duration(milliseconds: durationInMilliseconds),
