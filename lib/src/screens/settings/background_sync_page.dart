        ...
        children: [
          ...
          Observer(builder: (context) {
            return SettingsPickerCell<SyncMode>(
                ...
                onItemSelected: (dashboardViewModel.batteryOptimizationEnabled &&
                        dashboardViewModel.hasBatteryOptimization)
                    ? null
                    : (syncMode) async {
            ...
            Observer(builder: (context) {
              return SettingsSwitcherCell(
                ...
                onValueChange: (_, bool value) =>
                    dashboardViewModel.setBackgroundSyncNetworkUnmetered(value),
              );
            }),
          if (dashboardViewModel.hasBgsyncBatteryNotLowConstraints)
            Observer(builder: (context) {
              return SettingsSwitcherCell(
                ...
                onValueChange: (_, bool value) =>
                    dashboardViewModel.setBackgroundSyncBatteryNotLow(!value),
              );
            }),
          if (dashboardViewModel.hasBgsyncChargingConstraints)
            Observer(builder: (context) {
              return SettingsSwitcherCell(
                ...
                onValueChange: (_, bool value) =>
                    dashboardViewModel.setBackgroundSyncCharging(value),
              );
            }),
          if (dashboardViewModel.hasBgsyncDeviceIdleConstraints)
            Observer(builder: (context) {
              return SettingsSwitcherCell(
                ...
                onValueChange: (_, bool value) =>
                    dashboardViewModel.setBackgroundSyncDeviceIdle(value),
              );
            }),
          Observer(builder: (context) {
            return SettingsSwitcherCell(
