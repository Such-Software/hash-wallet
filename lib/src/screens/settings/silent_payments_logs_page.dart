...
class SilentPaymentsLogPage extends BasePage {
  ...
  final SilentPaymentsSettingsViewModel silentPaymentsSettingsViewModelBase;

  @override
  String get title => S.current.silent_payments_logs;
    ...
    return Stack(
      ...
      children: [
        FutureBuilder<String>(
          future: silentPaymentsSettingsViewModelBase.getAbbreviatedLogs(),
